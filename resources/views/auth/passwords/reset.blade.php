...
<head>
    ...
    <title>KLIN KLIN - Réinitialisation du mot de passe</title>
...
<body>
    <div class="container-fluid h-100">
        ...
        <div class="row h-100">
            ...
            <!-- Bloc droit - Formulaire de réinitialisation de mot de passe -->
            <div class="col-md-6 col-12 bg-white content-center col-right">
                <div class="form-container">
                    <div class="text-center mb-4">
                        ...
                        <p class="text-muted mb-4">Veuillez entrer votre nouveau mot de passe.</p>
                    </div>
                    ...
                    <form method="POST" action="{{ url('password/reset') }}">
                        ...
                        <div class="mb-3">
                            <input type="email" class="form-control @error('email') is-invalid @enderror" id="email" name="email" placeholder="Adresse e-mail" value="{{ $email ?? old('email') }}" required autocomplete="email" autofocus>
                            @error('email')
                        ...
                        <div class="mb-3">
                            <input type="password" class="form-control @error('password') is-invalid @enderror" id="password" name="password" placeholder="Nouveau mot de passe" required autocomplete="new-password">
                            @error('password')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="mb-4">
                            <input type="password" class="form-control" id="password-confirm" name="password_confirmation" placeholder="Confirmer le nouveau mot de passe" required autocomplete="new-password">
                        </div>
                        
                        <div class="d-grid">
                            <button type="submit" class="btn btn-purple">Réinitialiser le mot de passe</button>
                        </div>
                    </form>
