...
<head>
    ...
    <title>Confirmation d'achat de quota - KLINKLIN</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>Nous vous confirmons l'achat de votre forfait de quota de lavage.</p>
            ...
            <div class="subscription-details">
                ...
                <p><strong>Quota acheté :</strong> {{ $subscription->quota_purchased }} kg</p>
            ...
            <div class="highlight-box">
                <p><strong>Votre paiement a été confirmé et votre quota est maintenant disponible.</strong></p>
                <p>Vous pouvez dès à présent planifier une collecte pour utiliser votre quota.</p>
            </div>
            @else
            <div class="highlight-box">
                <p><strong>Votre paiement sera confirmé lors de la collecte/livraison.</strong></p>
                <p>Une fois confirmé, votre quota sera disponible pour vos commandes suivantes.</p>
            </div>
            @endif
