        ...
        <div class="card-body p-lg-5 p-4">
            ...
            <form id="orderForm" action="{{ route('orders.store') }}" method="POST">
                ...
                <div class="d-flex justify-content-between mt-5 pt-3 border-top">
                    <button type="button" class="btn klin-btn-outline prev-step" id="prevStepBtn" style="display: none;">
                        <i class="bi bi-arrow-left me-2"></i>Précédent
                    </button>
                    <button type="button" class="btn klin-btn next-step ms-auto" id="nextStepBtn">
...
{{-- Utiliser notre nouveau script complet --}}
<script src="{{ asset('js/order_complete.js') }}"></script>
@endpush