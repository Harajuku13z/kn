...
@section('title', 'Modifier la Configuration de Prix')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Modifier le Prix</h3>
                    ...
                    <form action="{{ route('admin.prices.update', $price) }}" method="POST">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.01" class="form-control @error('price_per_kg') is-invalid @enderror" 
                                           ...
                                           value="{{ old('price_per_kg', $price->price_per_kg) }}" required>
                                    @error('price_per_kg')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control @error('effective_date') is-invalid @enderror" 
                                           ...
                                           value="{{ old('effective_date', $price->effective_date->format('Y-m-d')) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('last_update_reason') is-invalid @enderror" 
                                      id="last_update_reason" name="last_update_reason" rows="3" required>{{ old('last_update_reason', $price->last_update_reason) }}</textarea>
