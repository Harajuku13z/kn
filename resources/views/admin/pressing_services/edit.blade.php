...
@section('title', 'Modifier un Service - KLINKLIN Admin')

@section('content')
<div class="container-fluid px-4">
    <h1 class="mt-4">Modifier un Service</h1>
    ...
    <div class="card mb-4">
        <div class="card-header bg-primary text-white">
            ...
            Modifier le Service de Pressing
        </div>
        <div class="card-body">
            @if ($errors->any())
            ...
            <form action="{{ route('admin.pressing-services.update', $service) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                        ...
                        <div class="card shadow-sm mb-3">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select class="form-select @error('category') is-invalid @enderror" id="category" name="category">
                                            ...
                                            @php
                                                $categories = ['Chemises', 'Pantalons', 'Costumes', 'Robes', 'Vestes', 'Manteaux', 'Linge de maison', 'Accessoires', 'Autre'];
                                            @endphp
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('estimated_time') is-invalid @enderror" id="estimated_time" name="estimated_time" value="{{ old('estimated_time', $service->estimated_time) }}" min="0">
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" role="switch" id="is_available" name="is_available" value="1" {{ old('is_available', $service->is_available) ? 'checked' : '' }}>
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <div class="mt-3 text-center">
                                        <img id="image-preview" src="{{ $service->image ? asset('storage/' . $service->image) : asset('images/placeholder-service.png') }}" alt="Aperçu de l'image" class="img-thumbnail" style="max-width: 100%; max-height: 150px;">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="d-flex justify-content-between">
                    <a href="{{ route('admin.pressing-services.index', ['pressing_id' => $service->pressing_id]) }}" class="btn btn-secondary">
